...
namespace AuthorizationLibrary
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection RegisterHandlers(this IServiceCollection services)
        {
            ...
            services.AddSingleton<IAuthorizationHandler, ListHandler>();
        ...
        {
            authorizationOptions.AddPolicy(ArticlePolicies.ListArticles2, p =>
                p.AddRequirements(new ListRequirement()));

            authorizationOptions.AddPolicy(ArticlePolicies.ListArticles1, p =>
